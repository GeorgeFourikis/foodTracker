...
def view(date):
    ...
    return render_template('day.html',entry_date=date_result['entry_date'], pretyy_date=pretty_date, food_results=food_results, log_results=log_results, totals=totals)
